...
The default `win_loci` is 5, however its choice is arbitrary.
...
With a chosen elastic window size of `r win_loci` loci, this will smooth the DAR metric at each origin locus with the DAR values of the `r (win_loci - 1) / 2` loci either side.
